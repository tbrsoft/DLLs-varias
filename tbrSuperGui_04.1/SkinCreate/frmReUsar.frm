...
Private G As tbrSuperGui_4.clsGUI

Dim Tipos() As tbrSuperGui_4.ObjFullPadre  'todos los de un mismo tipo sera hijos de un mismo padre para mostrarse juntos uno debajo del otro
Dim tipoElegido As Long 'en cada momento que frm esta elegido

'ultimo objeto elegido para usar en el skineador
Public ObjElegido As tbrSuperGui_4.objFULL
...
Public Sub CargarTodo(Optional mModal As Long = 0)
    ...
    Dim OG() As New tbrSuperGui_4.objFULL  'creo un objeto que lo cargara y mostrar
    Dim C As Long
