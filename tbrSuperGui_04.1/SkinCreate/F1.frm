...
Private G As tbrSuperGui_4.clsGUI 'gui abierto
...
Private ObjElegido As tbrSuperGui_4.objFULL
...
Private Sub OpenSkin(sFile As String)
    ...
    Set G = New tbrSuperGui_4.clsGUI
...
Private Sub mnAddForm_Click()
    ...
    Dim tmpPadre As tbrSuperGui_4.ObjFullPadre
...
Private Sub mnAddObj_Click()
    Dim OG As New tbrSuperGui_4.objFULL
...
Private Sub mnDetail_Click()
    MsgBox PadreActual.toString
End Sub
...
Private Sub PicPadre_MouseUp(Index As Integer, Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If PadreActual.GetSgoByID(ixSEL).Tipo = en_clsTemasManager Then
        Dim OB As tbrSuperGui_4.clsTemasManager
