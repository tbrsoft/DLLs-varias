    ...
    If Not (TView1.SelectedItem Is Nothing) Then
         ...
         tvNode.Expanded = True
            If tvNode.Text = ".." Then
                ...
                adr = Klic & fPat
            Else
                'el KEY de cada nodo es todo lo del path del ftp menos lo inicial
                'ej: en ftp.tbrsoft.com\psi\tst\ el key es "\psi\tst\"
                Klic = tvNode.Key
                adr = Klic & fPat
            End If
            
            'BORRA LOS HIJOS DE LOS HIJOS APARENTEMENTE
            'CUANDO VUELVE CARPTAS PARA ATRAS SERVIRA ¿?...
