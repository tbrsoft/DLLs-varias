...
#define MyAppName "tbrTestTbrErrores"
#define MyAppVerName "tbrTestTbrErrores"
#define MyAppPublisher "tbrSoft Internacional"
#define MyAppURL "http://www.tbrsoft.com"
#define MyAppExeName "ProbarTbrErrores.exe"
...
AllowNoIcons=no
OutputBaseFilename=InstalarProbarTbrErrores
...
Source: "D:\dev\DLL\MODULO ERR\EJEMPLO\ProbarTbrErrores.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\dev\DLL\MODULO ERR\EJEMPLO\Form1.frm"; DestDir: "{app}"; Flags: ignoreversion
;Source: "D:\dev\DLL\MODULO ERR\EJEMPLO\Form1.frx"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\dev\DLL\MODULO ERR\EJEMPLO\Proyecto1.vbp"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\dev\DLL\MODULO ERR\EJEMPLO\Proyecto1.vbw"; DestDir: "{app}"; Flags: ignoreversion
;Source: "D:\dev\DLL\MODULO ERR\EJEMPLO\CommonDialog.cls"; DestDir: "{app}"; Flags: ignoreversion

[Icons]
Name: "{group}\{#MyAppName}\ProbarTbrErrores"; Filename: "{app}\{#MyAppExeName}"
