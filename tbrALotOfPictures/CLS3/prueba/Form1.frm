VERSION 5.00
Object = "{75802354-F5C4-4E86-B421-A1441691524B}#5.0#0"; "tbrALotOfPictures.ocx"
Begin VB.Form Form1 
   Caption         =   "Form1"
   ClientHeight    =   6630
   ClientLeft      =   60
   ...
   Begin tbrAlotOfPictures.tbr_AlotOfPictures LOP 
      Height          =   405
      Left            =   6420
      TabIndex        =   7
      Top             =   570
...
Private Sub Command1_Click()
    ...
    For H = 1 To 10
        Randomize
            ...
            Set Picture1(H).Picture = LOP.SetPicture(IMGs(H2))
            
        Randomize
            H2 = Int(Rnd * UBound(IMGs))
            Set Image1(H).Picture = LOP.SetPicture(IMGs(H2))
    Next H
