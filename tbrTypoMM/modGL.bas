...
'no se como hacer para que una instancia de modPrecios sepa valores de la clase abuela typoMM_mng

'saber si los precios se muestran como creditos o como plata
Public ShowCreditsMode As Long
'0 es plata, 1 es creditos

Public Pesos1Cred As Single 'valor monetario de cada crédito
