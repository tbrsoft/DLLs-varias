...
Public Const WM_CAP_DRIVER_CONNECT = WM_CAP_START + 10 'ya puede obtener imaganes si quisiera
...
Public Const WM_CAP_EDIT_COPY = WM_CAP_START + 30 ' si tome un frame lo puedo meter en clipboard con esto...
...
Public Const WM_CAP_GRAB_FRAME = WM_CAP_START + 60 'toma un frame ...
